...
<jsp:useBean id="product" class="com.bean.Product" scope="request"/>
<body>
		<div id="page">
			<div id="header">
			...
			<div id="center_column">				
				...
				<div id=item_other>
					<form action="cart_add" method="post">
						品&nbsp;&nbsp;&nbsp;&nbsp;名：&nbsp;<span  style="font-size:15px;font-weight:bold;"><jsp:getProperty property="name" name="product" /><!-- 油漆边双色龙骨扇_粉色 --></span><br>
						原&nbsp;&nbsp;&nbsp;&nbsp;价：&nbsp;<span  style="text-decoration: line-through;"><jsp:getProperty property="price" name="product" /></span><br>
				...
				<div id="item_parameter">
					<div style="float: left;width:230px;color:#404040;">&nbsp;&nbsp;&nbsp;货号：<jsp:getProperty property="sort" name="product" /></div><div style="float: left;width:230px;color:#404040;">类别：trt</div><div style="float: left;width:230px;color:#404040;">扇面材质:<jsp:getProperty property="face" name="product" /></div><br>
				...
				<div id="item_show_img">
					<img src="<jsp:getProperty property="source" name="product" />" />
				</div>
			</div>
