    	...
    	<td background=images/line_04.gif></td>
      	<td>
        		<div id="left_sort">
    				...
    				<div id="sort_menu">
    				<ul id="menu">
     					<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="product?id=1">日式女扇</a></li>
     					<hr size="1" />
     					<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="product?id=2">仿古男扇</a></li>
     					<hr size="1" />
   						<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="product?id=3">韩国扇</a></li>
   						<hr size="1" />
   						<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="product?id=4">檀香扇</a></li>
   						<hr size="1" />
   						<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="product?id=5">礼品广告扇</a></li>
   					</ul>
   					</div>
  				</div>
